...
import styles from '@/css/pages/basket.module.css'
            ...
            {item._basketItems.length !== 0 ?
                <div>
                    <div className={general.height}>
                        <div className={`container ${styles.section_line}`}>
                            <div className="row">
                                <h1 className={styles.your_basket + ' col-xxl-4 offset-xxl-0 col-xl-4 offset-xl-0 col-lg-4 offset-lg-0 col-md-5 offset-md-0 col-sm-6 offset-sm-0 col-12'}>Ваша
                                    корзина</h1>
                                <div
                                    className={styles.help_clean + ' col-xxl-1 offset-xxl-4 col-xl-1 offset-xl-4 col-lg-1 offset-lg-4 col-md-1 offset-md-2 col-sm-2 offset-sm-0 col-2 offset-2'}>
                                    <div className={styles.clean_all} onClick={deleteAllBasketItems}>
                                        <Image src={X_BLACK} alt="" className={styles.close}/>
                                    </div>
                                </div>
                                <button
                                    className={styles.checkout + ' col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-sm-4 col-5'}
                                    onClick={createOrder}>
                                    Оформить заказ
                                    <Image src={SHOP_CARD} alt="" className={styles.card}/>
                                </button>
                            </div>
                        </div>
                ...
                :
                <p className={styles.empty_text}>Добавьте товары</p>
            }
        </div>
    );
}
