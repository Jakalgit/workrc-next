                ...
                <div className="row">
                    <div className={style_css.part + " col-xxl-6 offset-xxl-0 col-xl-6 offset-xl-0 " +
                        ...
                        <div style={{position: "relative", overflow: "hidden"}}>
                            <iframe className={style_css.iframe} title="yandex-maps"
                                    src="https://yandex.ru/map-widget/v1/-/CCUJR8uKdC"
                    ...
                    <div className={style_css.part + " col-xxl-6 offset-xxl-0 col-xl-6 offset-xl-0 " +
                        ...
                        <div className={style_css.chats}>
                            <a href="https://t.me/Pash_Rc" target="_blank"
                               className={style_css.tg + ' ' + style_css.back}>
                                <Image
                            ...
                            <>
                                {window.innerWidth < 575 ?
                                    <h1 className={style_css.com_text}>
                                        <strong>WORK-RC</strong> - это дружеский коллектив моделистов с большим опытом и
                                        знаниями,
                    ...
                    <p className={style_css.head_text + ' ' + style_css.help}>
